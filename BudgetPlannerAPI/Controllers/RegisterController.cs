...
namespace BudgetPlannerAPI.Controllers
{
    ...
    public class RegisterController : ControllerBase
    {
        ...
        public RegisterController(SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager, IEmailSender emailSender, IBudgetUserService budgetUserService, IUserRoleService userRoleService)
        {
